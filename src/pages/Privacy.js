                ...
                <div className="row">
                    <div className="col">
                        <h6><strong>Billing and payment information</strong></h6>
                            ...
                            <p>participate in contests and surveys, apply for a job, or otherwise participate in activities we promote that might require information about you.</p>
                            <p>However, we also collect additional information when delivering our Services to you to ensure necessary and optimal performance. These methods of collection may not be as obvious to you, so we thought we’d highlight and explain a bit more about what these might be as they vary from time to time.</p>
                    ...
                    <div className="row">
                        <div className="col">
                            <h6><strong>How we utilize information.</strong></h6>
                                ...
                                <p>Improve and optimize the operation and performance of our Services (again, including our websites and mobile applications)</p>
                                ...
                                <p>Services, and with trusted third party service providers as necessary for them to perform services on our behalf, such as: processing credit card payments. Serving advertisements "more on this topic below".</p>
                                <p>Conducting contests or surveys</p>
                                <p>Performing analysis of our services, customer demographics, and sentiment, communicating with you, such as by way of email or survey delivery.</p>
                    ...
                    <div className="row">
                        <div className="col">
                            <h6><strong>How we secure, store and retain your data.</strong></h6>
                                ...
                                <p>Whether account owners modify or their users delete information through their accounts whether we have a legal obligation to keep the data for example, certain laws require us to maintain records of your transactions for a certain period of time before we can delete them; or</p>
                    ...
                    <div className="row">
                        <div className="col">
                            ...
                            <h6><strong>Non-Discrimination.</strong></h6>
                                <p>We will not discriminate against you for exercising any of your privacy rights. Unless permitted under applicable laws, we will not deny you goods or services.</p>
