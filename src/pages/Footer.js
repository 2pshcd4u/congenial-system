export default function Footer() {
    return (        
        <div className="container text-center">
            <div className="row">
                <div className="col">                        
                    <a id="meta" title="Facebook" href="https://www.facebook.com/profile.php?id=100085223613654/">
                        <svg xmlns="http://www.w3.org/2000/svg" width={32} height={24} fill="silver" className="bi bi-meta" viewBox="0 0 16 16">
                            ...
                            <Link to='/privacy'>
                                <a className="nav-link p-2" title="Privacy" href="./privacy">                         
                ...
                <div className="col">                
                    <img src={wglogo} width={200} height={80} alt="Logo" />
                </div>
            </div>
        </div>
        );    
