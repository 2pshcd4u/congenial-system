  ...
  return (
   ...
   <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-black">
        <div class="container-fluid">
            <a class="navbar-brand" href="./images/bwlogo.png">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <Link to='/'>
                                <a class="nav-link p-2 text-white" aria-current="page" title="home" href="/">                                
                        ...
                        <li class="nav-item">
                            <a class="nav-link p-2 text-white" aria-current="page" title="Technical Support" href="https://cloudtensolutions.atlassian.net/servicedesk/customer/portal/2">
                        ...
                        <li class="nav-item">
                            <Link to='/privacy'>
                            <a class="nav-link p-2 text-white" href="./privacy">                         
